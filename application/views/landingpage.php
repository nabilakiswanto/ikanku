	...
	<div class="size1 overlay1">
		...
		<div class="w-full flex-w flex-sb-m p-l-65 p-r-80 p-t-22 p-b-185 p-lr-15-sm respon8">
			<div class="wrappic1 m-r-30 m-t-10 m-b-10">
				<a id="ikanku" href="https://ikanku.net/Auth"><img src="/images/icons/logoikanku.webp" alt="LOGO" height="67" weight="67"></a>
			</div>

			<div class="flex-w m-t-10 m-b-10">
			    <a id="ikankulogin" href="https://ikanku.net/Auth"><button id="tombolikanku" class="size2 m1-txt1 flex-c-m how-btn1 trans-04" >Login
						</button></a>
			</div>
		</div>
